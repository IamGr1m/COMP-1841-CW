                    ...
                    <h5><a style="color:white; dispaly:flex; margin-left:90%;" href="phpmailer/mail.php">Contact Us.</a></h5>
                        ...
                        <nav>
                            <ul>
                                ...
                                <li><a class="navigationbutton" style="box-shadow: 0 0 10px rgba(0, 0, 0, 5);" href="modules.php"><b>Modules</b></a></li>
                                <li><a class="navigationbutton" style="box-shadow: 0 0 10px rgba(0, 0, 0, 5);" href="users.php"><b>Users List</b></a></li>
                            </ul>
                        </nav>
