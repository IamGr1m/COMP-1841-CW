        ...
        <div class="container">
                <div class="box">
                        ...
                        <form action="login_query.php" method="POST">  
                                <h5 class="label2"><b>Admin</b> Login here...</h5>
                                ...
                                <br />
                                <div class="form-group">
                                        <button class="btn btn-secondary form-control" name="admin_login">Login</button>
                                </div>
                                <br/>
                        </form>
                                <div class="form-group2">
                                        <button class="btn btn-secondary" name="admin_login" onclick="backtologin()">Back to User Login</button>
                                </div>
                                <br/>
                                <div class="form-group1">
                                        <div class="label1">Need an account ?</div>
                                        <a class="label2" href="registration.php">Registration</a>
                                </div>
                        </div>
                </div>
        </div>
